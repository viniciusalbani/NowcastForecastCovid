...
Death(3:end) = min(1,data2(2:end,2)./data2(1:end-1,1))/gamma;
...
UB = 10;
for jj = 1:ext
OF = @(unknowns)ObjFun_BetaWithoutAge(t_actual(jj:jj+1),params,data2(jj,:),options,priors,yinit2,unknowns);
