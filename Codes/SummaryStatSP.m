...
SummarySP1 = zeros(25,6);
SummarySP2 = zeros(25,6);
CI90SP1= zeros(15,6);
CI90SP2= zeros(15,6);
time=[10,15,30,45,60,90];
for zz = 1:6
load(['data_SP_20220101_',num2str(time(zz)),'dias.mat']);
...
SummarySP1(:,zz) = reshape(aux,1,25)';

aux = [CI90(1,:);median(Err1);CI90(2,:)];
CI90SP1(:,zz) = reshape(aux,1,15)';
%%%%%%%%%%
aux = sort(Err2);
aux2 = round(0.25*NSamples);
aux = aux(aux2+1:end-aux2,:);
...
SummarySP2(:,zz) = reshape(aux,1,25)';

aux = [CI90(1,:);median(Err1);CI90(2,:)];
CI90SP2(:,zz) = reshape(aux,1,15)';
if zz==1
aux = sort(coefMR(:,1));
...
box on
title('Sao Paulo - BR')
plot(tt,CI90SP1(2,:),'-sb','LineWidth',2)
plot(tt,CI90SP1(5,:),'-og','LineWidth',2)
plot(tt,CI90SP1(8,:),'-+r','LineWidth',2)
plot(tt,CI90SP1(11,:),'-^m','LineWidth',2)
plot(tt,CI90SP1(14,:),'-*c','LineWidth',2)
...
hold off
saveas(gcf,'SP_MEDIANErr1.fig');
print('-dpng','SP_MEDIANErr1');

AUX = [CI90SP1(2:3:end,1),CI90SP1(1:3:end,1),CI90SP1(3:3:end,1),CI90SP1(2:3:end,2),CI90SP1(1:3:end,2),CI90SP1(3:3:end,2),CI90SP1(2:3:end,3),CI90SP1(1:3:end,3),CI90SP1(3:3:end,3),...
CI90SP1(2:3:end,4),CI90SP1(1:3:end,4),CI90SP1(3:3:end,4),CI90SP1(2:3:end,5),CI90SP1(1:3:end,5),CI90SP1(3:3:end,5),CI90SP1(2:3:end,6),CI90SP1(1:3:end,6),CI90SP1(3:3:end,6)]/100;